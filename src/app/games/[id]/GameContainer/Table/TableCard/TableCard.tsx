...
export default function TableCard({ player, isRevealed, isCurrentPlayer }: { player: Player, isRevealed: boolean, isCurrentPlayer: boolean }) {

  const { score, name } = player

  return (
    <motion.div className={`bg-accent text-darkText text-center font-medium w-32 h-40 rounded-lg
