...
export default function Home() {
  ...
  return (
    <section className='text-center flex flex-col gap-12 w-4/5'>
      ...
      <Heading2>'The most fun you will ever have estimating...' - <i>Me</i></Heading2>
      ...
      <Link href="/new">
        <span className='bg-accent/75 text-darkText font-semibold tracking-wide p-6 rounded-4xl shadow-xl h-16 hover:bg-accent duration-200'><ButtonLabel>Create Game</ButtonLabel></span>
      </Link>
    </section>
  )
}
